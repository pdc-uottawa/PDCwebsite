...
const UpdateResumeLinkedInReviewLink = (props) => {
  const path = config();
  ...
  function handleSubmit() {
    ...
    if (!link) {
      ...
      if (
        ...
        Axios.post(path + "cdc/links/update", {
          _id: id,
          link,
        })
          .then((res) => {
  ...
  return (
    <>
      <Helmet>
        <title>Update Mock Interview Link | Professional Development Club</title>
      </Helmet>
      {user && user.admin ? (
        <div className="admin-dashboard">
          ...
          <div className="admin-home">
            {loading ? (
              ...
              <>
                <h2 className="admin-h2">Edit Resume/LinkedIn Review Link</h2>
                <h4 className="red">
...
export default UpdateResumeLinkedInReviewLink;
