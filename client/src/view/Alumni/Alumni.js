                ...
                <Grid columns={4} stackable textAlign="center">
                    <Grid.Row>
                        {AlumniMembers.map((alumni,index)=><Grid.Column  id="column">
                            ...
                            <h3>{DOMpurify.sanitize(alumni.name)}</h3>
                            <h3>{DOMpurify.sanitize(alumni.position)}</h3>
                            <div  id="socialMediaIconsContainer">
                                ...
                                <a href={"mailto:"+ DOMpurify.sanitize(alumni.mailId)} target="_blank"> <Image src={"/assets/outlook.png"}  id="socialMediaIcon"/></a>
                            </div>
                        </Grid.Column>)}
                    </Grid.Row>
                    <Grid.Row>
